...
def _build_batch_prompt(
    ...
    system = (
        ...
        "• A number is welcome but NOT required in every title; an existing number like '365' or '2026' "
        "or a specific quantity already counts. Do NOT prepend a listicle count (e.g. '5 Proven…') to titles "
        "that read fine without one.\n"
