...
EN_SYSTEM_PROMPT = (
    ...
    "with ':' or '-'), max 60 characters, professional tone - never clickbait. The title should contain a "
    "number, but an existing number like '365' or '2026' or a specific quantity already satisfies this - "
    "do NOT force a leading listicle count when the title already has a number. Prefer the organic number "
    "over a count. Use a power word (Proven, Essential, Practical, Definitive, …) only where it fits "
    "naturally. Prefer varied, natural phrasing over the repetitive 'Number + PowerWord + Topic' pattern. "
    "Examples: 'Copilot Alternative: A Practical EU-Ready Guide for 2026' or 'Microsoft 365 Copilot "
    "Governance in 2026'.\n"
